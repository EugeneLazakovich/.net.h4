    ...
    public class InfesDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Human>().HasData(
                ...
                new Human { Id = 8, FirstName = "Petr", LastName = "Ilich", Age = 53, IsSick = true, Gender = "Male", CountryId = 4 },
                new Human { Id = 9, FirstName = "Thomas", LastName = "Edison", Age = 84, IsSick = true, Gender = "Male", CountryId = 1 });
        }
    }
}
